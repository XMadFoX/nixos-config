  ...
  wayland.windowManager.hyprland = {
    ...
    settings = {
      ...
      general = {
        ...
        "col.active_border" = "0xff$mauveAlpha 0xff$skyAlpha 0xff$mauveAlpha 0xff$redAlpha 0xff$mauveAlpha 0xff$skyAlpha 0xff$mauveAlpha 0xff$skyAlpha 0xff$mauveAlpha 0xff$redAlpha 315deg";
